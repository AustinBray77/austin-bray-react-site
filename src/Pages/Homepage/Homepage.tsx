			...
			<Container>
				<Row className="justify-content-center">
					<HPCard>
						...
						<p>
							This website is a hub for viewing all of my projects and progress
							in the field of computer science. Through this, I hope to give you
							a look at what I am capable of and what I could possibly do for
							you.
						</p>
					</HPCard>
					<HPCard>
				...
				<Row className="justify-content-center">
					<HPCard>
						...
						<p style={{ paddingBottom: 60 }}>
							I have created many different coding projects through my 4+ years
							of programming. The button below will take you to a page showing
							off all of my projects.
						</p>
						<button
