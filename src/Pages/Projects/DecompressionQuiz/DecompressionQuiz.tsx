...
export default function DecompressionQuiz(): JSX.Element {
    ...
    const generateQuestions = (): number[] => {
        let questionOrder: number[] = Array.from(
        ...
        >
            {!isFinished || moveBackground ? (
                    ...
                    <Col xs={6}>
                        ...
                        <Row>
                            {incorrectAnswers === 1 ? (
                                <div>
                                    <h3>
                                        Oh no, you answered a question wrong so
                                        you ascended too quickly.
                                    </h3>
                                    <h3>
                                        You are currently experiencing minor
                                        symptoms like inflammation in muscle and
                                        joints, rashes, trouble with balance,
                                        fatigue, joint & muscle pain, weakened
                                        urinary tract.
                                    </h3>
                                </div>
                            ) : incorrectAnswers === 2 ? (
                                <div>
                                    <h3>
                                        Oh no, you answered another question
                                        wrong so you ascended too quickly again.
                                    </h3>
                                    <h3>
                                        You are now paralyzed and are unable to
                                        continue ascending, causing you to drown
                                        as your air tank runs out.
                                    </h3>
                                </div>
                            ) : (
                                <div></div>
                ...
                <div className="text-dark text-center py-5">
                    <h1>
                        Congrats you completed the quiz with a{" "}
                        {5 - incorrectAnswers}/5 and survived!
                    </h1>
