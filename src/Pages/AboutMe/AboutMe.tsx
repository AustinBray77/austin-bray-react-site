	...
	return (
		<Container id="AboutMe">
			<Row className="justify-content-center">
				<Col xs={8} className="bg-dark text-light br-10 my-4 py-4">
					<div className="mb-5 text-center px-5">
						...
						<p>
							...
							multitude of languages and environments, alone or in a team, and
							for work or for fun. Currently I serve as the head web master of
							the{" "}
